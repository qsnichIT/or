 ...
 * of data into the <tt>{@link #store}</tt> by passing {@link Ext.data.Store#paramaterial_names paramaterial_names} used for
 * paging criteria.</p>
...
Ext.PagingToolbar = Ext.extend(Ext.Toolbar, {
    ...
    /**
     * <p><b>Deprecated</b>. <code>paramaterial_names</code> should be set in the <b>data store</b>
     * (see {@link Ext.data.Store#paramaterial_names}).</p>
     * <br><p>Object mapping of parameter names used for load calls, initially set to:</p>
     * <pre>{start: 'start', limit: 'limit'}</pre>
     * @type Object
     * @property paramaterial_names
     * @deprecated
     */
    ...
    initComponent : function(){
        ...
        this.addEvents(
             ...
             * by the store's {@link Ext.data.Store#paramaterial_names paramaterial_names} property.)</p>
    ...
    getParams : function(){
        ...
        return this.paramaterial_names || this.store.paramaterial_names;
    },
