...
*/
    ...
    reload : function () {
        if (this.local) {
            ...
            this.deferredUpdate.cancel();
            if (this.toolbar) {
                start = store.paramaterial_names.start;
...
Ext.ux.form.ItemSelector = Ext.extend(Ext.form.Field,  {
    ...
    onRender: function(ct, position){
        ...
        if (!this.claimIcon || this.hideNavIcons) { this.downIcon.dom.style.display='none'; }
...
Ext.ux.form.SearchField = Ext.extend(Ext.form.TwinTriggerField, {
    ...
    onTrigger1Click : function(){
        if(this.hasSearch){
            ...
            this.store.baseParams[this.paramaterial_name] = '';
    ...
    onTrigger2Click : function(){
        ...
        var o = {start: 0};
        this.store.baseParams = this.store.baseParams || {};
        this.store.baseParams[this.paramaterial_name] = v;
        this.store.reload({params:o});
        this.hasSearch = true;
