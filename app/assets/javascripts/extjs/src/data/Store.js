...
var store = new Ext.data.Store({
     ...
     * case-sensitive. See also {@link #remoteSort} and {@link #paramaterial_names}.
     ...
     * object takes the following form:</p><pre><code>
{
     ...
     */
    paramaterial_names : undefined,

    /**
     * @cfg {Object} defaultParamaterial_names
     * Provides the default values for the {@link #paramaterial_names} property. To globally modify the parameters
     * for all stores, this object should be changed on the store prototype.
     */
    defaultParamaterial_names : {
        start : 'start',
        limit : 'limit',
        sort : 'sort',
        dir : 'dir'
    ...
    constructor : function(config){
        ...
        this.paramaterial_names = Ext.applyIf(this.paramaterial_names || {}, this.defaultParamaterial_names);
     ...
     * <code>{@link #paramaterial_names}</code>.</li>
     * </ul></div>
    ...
    load : function(options) {
        ...
        if(this.sortInfo && this.remoteSort){
            var pn = this.paramaterial_names;
...
myStore.reload(lastOptions);
     ...
     * sorting is used, the cache is sorted internally. See also {@link #remoteSort} and {@link #paramaterial_names}.
